...
public class EdgeDoubleWeighted implements Comparable<EdgeDoubleWeighted> {

    private final int v;
    private final int w;
    private final double stWeight;
    private final double ndWeight;
     ...
     */
    public EdgeDoubleWeighted(int v, int w, double stWeight, double ndWeight) {
    ...
    public String toString() {
        return String.format("%d-%d %.5f %.5f", v, w, stWeight, ndWeight);
    }
}